...
function AmountCategorisedGraph() {
    ...
    const defaultStart = new Date(now.getTime() - 60 * 60 * 1000); // за годину
    ...
    return <div>
        <div className="flex justify-center gap-20 p-4 bg-stone-100">
            <div className="flex flex-col gap-2">
                ...
                {user && user.role !== "admin" && <div className="flex h-full gap-2">
...
export default observer(AmountCategorisedGraph);