...
function AverageGraph() {
    ...
    const getData = async () => {
        try {
            ...
            setLoading(true);
            const result = await analyticsService.calculateAverage(credentials);
    ...
    useEffect(() => {
        if (user && (user.role === "admin" || selectedObjectId)) getData();
    ...
    return <div>
        <div className="flex justify-center gap-20 p-4 bg-stone-100">
            <div className="flex flex-col gap-2">
                ...
                <div className="flex h-full gap-2">
                    ...
                    {user && user?.role !== "admin" && <ObjectSelector
        ...
        <div id="graph-section" className="flex flex-col gap-10 p-8">
...
export default observer(AverageGraph);